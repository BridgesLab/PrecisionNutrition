...
# All models report per this unit
LDL_SCALE <- 10   # per 10 mg/dL throughout
```
...
1. **Baseline LDL-C** — first measurement (mg/dL), per `r LDL_SCALE` mg/dL
2. **Time-varying LDL-C** — LOCF, primary 1825d / sensitivity 730d, per `r LDL_SCALE` mg/dL
3. **Time-averaged LDL-C** — AUC ÷ follow-up years (mg/dL), per `r LDL_SCALE` mg/dL
