...
| Significant SNPs               | `r nrow(calcium.clumps.expanded)`    |
...
| Significant SNPs               | `r nrow(tc.clumps.expanded)`    |
...
| Significant SNPs               | `r nrow(ldlc.clumps.expanded)`    |
