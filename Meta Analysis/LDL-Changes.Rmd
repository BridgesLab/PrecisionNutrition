...
#need more details added here --> how did we find other studies (literature search for all studies using a KD diet that met our inclusion criteria, most recently updated this search on (whatever date is most up to date)) --> A systematic literature search of Embase, PubMed, and Cochrane Library was performed to identify randomized controlled trials (RCTs) and single-arm interventions of patients that evaluated the effects of a ketogenic diet on glycemic control, weight loss, and lipid profile as primary endpoints. all studies using a KD diet that met our inclusion criteria xxx . most recently updated this search on (whatever date is most up to date))
