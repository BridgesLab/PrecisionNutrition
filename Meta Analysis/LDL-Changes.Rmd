...
Correlations in this meta-analysis before and after the administration of the ketogenic diet were analyzed with linear models and results given using pearsons correlation coefficient. p-values were estimated from 2-sided tests and considered statistically significant when below 0.05. 
