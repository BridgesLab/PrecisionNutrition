...
There were `r nrow(correlation.association.papers)` papers with the words correlation or association in the title or abstract. There were `r nrow(correlation.papers)` papers with the word correlation in the title or abstract.  Of those `r correlation.papers |> filter(is.na(Correlations)) |> nrow()` remain to be evaluated
