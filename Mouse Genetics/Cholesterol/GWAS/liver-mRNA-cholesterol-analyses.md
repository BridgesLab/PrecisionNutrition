...
```{.r .cell-code}
library(tibble)
genes.of.interest <- c('Chrna2','Srebf1','Srebf2','Clstn3','Kif13b','Ascc3','Apoa1','Apoa2','Lpin1','Cdkal1','Bdh1', 'Hmgcs2', 'Hmgcl','Hmgcr','Apoa2','Hnf1a','Mmab','Ldlr','Slc16a1','Slc16a6','Slc16a7','Mvk','Cyp7a1','Cyp7b1','Cyp27a1','Tcerg1') #error with Slc16a3/8
...
```{.r .cell-code}
library(pheatmap)
cholesterol.genes <- c('Hmgcl','Hmgcs2','Hmgcr','Bdh1','Slc16a1','Slc16a3','Slc16a6','Slc16a7','Slc16a8','Ldlr','Mvk','Cyp7a1','Cyp7b1','Cyp27a1','Srebf2')
...
other attached packages:
 ...
 [5] forcats_1.0.0   stringr_1.5.1   purrr_1.1.0     tibble_3.3.0   
 [9] ggplot2_3.5.2   tidyverse_2.0.0 broom_1.0.8     tidyr_1.3.1    
[13] dplyr_1.1.4     readr_2.1.5    

loaded via a namespace (and not attached):
 [1] generics_0.1.4     stringi_1.8.7      lattice_0.22-7     hms_1.1.3         
 [5] digest_0.6.37      magrittr_2.0.3     evaluate_1.0.4     grid_4.4.0        
 [9] timechange_0.3.0   RColorBrewer_1.1-3 fastmap_1.2.0      jsonlite_2.0.0    
[13] Matrix_1.7-3       backports_1.5.0    mgcv_1.9-3         scales_1.4.0      
[17] textshaping_1.0.1  cli_3.6.5          crayon_1.5.3       rlang_1.1.6       
[21] bit64_4.6.0-1      splines_4.4.0      withr_3.0.2        yaml_2.3.10       
[25] parallel_4.4.0     tools_4.4.0        tzdb_0.5.0         vctrs_0.6.5       
[29] R6_2.6.1           lifecycle_1.0.4    snakecase_0.11.1   bit_4.6.0         
[33] htmlwidgets_1.6.4  vroom_1.6.5        ragg_1.4.0         pkgconfig_2.0.3   
[37] pillar_1.11.0      gtable_0.3.6       glue_1.8.0         systemfonts_1.2.3 
[41] xfun_0.52          tidyselect_1.2.1   rstudioapi_0.17.1  farver_2.1.2      
[45] htmltools_0.5.8.1  nlme_3.1-168       rmarkdown_2.29     labeling_0.4.3    
[49] compiler_4.4.0    
```
:::
:::
