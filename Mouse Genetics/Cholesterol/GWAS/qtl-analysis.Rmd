...
aov(chol1~sex*Genotype, data=annotated.phenotypes %>%
  filter(diet=='chow') %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='ANOVA for sex-genotype interaction on chow only.')

lm(chol1~sex+Genotype, data=annotated.phenotypes %>%
  filter(diet=='chow') %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='ANOVA for sex-genotype interaction.')

aov(chol1~diet*sex*Genotype, data=annotated.phenotypes %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='ANOVA for moderation of genotype effect by diet.')

aov(chol1~diet+sex+Genotype+diet:Genotype, data=annotated.phenotypes %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='ANOVA for moderation of genotype effect by diet.')

lm(chol1~diet+sex+Genotype+diet:Genotype, data=annotated.phenotypes %>%
  filter(Genotype!='--')) %>%
  tidy %>%
...
second.annotated.phenotypes %>%
  ...
  geom_errorbar(width=0.5)+
  labs(y='Cholesterol (mg/dL)',
       x=paste('Genotype at ',paste(paste('Chr',second.snp$chr,sep="")) %>% paste(second.snp$ps, sep=':')))
...
aov(chol1~sex*Genotype, data=second.annotated.phenotypes %>%
  filter(diet=='chow') %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='ANOVA for sex-genotype interaction on chow only.')

lm(chol1~sex+Genotype, data=second.annotated.phenotypes %>%
  filter(diet=='chow') %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='linear model for sex-genotype interaction.')

aov(chol1~diet + sex + Genotype, data=second.annotated.phenotypes %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='ANOVA for moderation of genotype effect by diet.')

aov(chol1~diet+sex+Genotype+diet:Genotype, data=second.annotated.phenotypes %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='ANOVA for moderation of genotype effect by diet.')

lm(chol1~diet+sex+Genotype+diet:Genotype, data=second.annotated.phenotypes %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='Model estimates for moderation of genotype effect by diet.')
```
...
third.annotated.phenotypes %>%
  ...
  geom_errorbar(width=0.5)+
  labs(y='Cholesterol (mg/dL)',
       x=paste('Genotype at ',paste(paste('Chr',third.snp$chr,sep="")) %>% paste(third.snp$ps, sep=':')))
...
aov(chol1~sex*Genotype, data=third.annotated.phenotypes %>%
  filter(diet=='chow') %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='ANOVA for sex-genotype interaction on chow only.')

lm(chol1~sex+Genotype, data=third.annotated.phenotypes %>%
  filter(diet=='chow') %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='linear model for sex-genotype interaction.')

aov(chol1~diet*sex*Genotype, data=third.annotated.phenotypes %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='ANOVA for moderation of genotype effect by diet.')

aov(chol1~diet+sex+Genotype+diet:Genotype, data=third.annotated.phenotypes %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='ANOVA for moderation of genotype effect by diet.')

lm(chol1~diet+sex+Genotype+diet:Genotype, data=third.annotated.phenotypes %>%
  filter(Genotype!='--')) %>%
  tidy %>%
  kable(caption='Model estimates for moderation of genotype effect by diet.')
```
...
add.formula <- as.formula(paste('chol1~sex+', paste(lead.snps,collapse="+")))
int.formula <- as.formula(paste('chol1~sex+', paste(lead.snps,collapse="*")))
...
hfd.r2 <- cor.test(predict(prs.add,newdata = annotated.lead.phenotypes.hfd),
                   annotated.lead.phenotypes.hfd$chol1)
...
```{r prs-variance}
full.formula <- as.formula(chol1~sex+diet+sex:diet+UNC19008219 + UNC21619767 + backupUNC060370616+diet:UNC19008219 + diet:UNC21619767 + diet:backupUNC060370616)
