...
| 0.064|      1|     0.753|  0.754| 0.045|
| 0.060|      2|     0.689|  0.718| 0.044|
| 0.036|      3|     0.629|  0.645| 0.044|
| 0.023|      4|     0.593|  0.641| 0.044|
| 0.022|      5|     0.569|  0.643| 0.044|
| 0.015|      6|     0.547|  0.631| 0.044|
| 0.015|      7|     0.532|  0.646| 0.044|
| 0.014|      8|     0.516|  0.655| 0.044|
| 0.011|      9|     0.502|  0.646| 0.043|
| 0.011|     10|     0.491|  0.660| 0.047|
| 0.010|     11|     0.481|  0.660| 0.047|
...
cholesterol.data %>%
  group_by(sex,diet) %>%
  filter(!is.na(calcium2)) %>%
  summarise(mean = mean(calcium2, na.rm=T),
            sd = sd(calcium2, na.rm=T),
            se = se(calcium2)) %>%
  kable(caption="Summary statistics for calcium for complete DO dataset")
```



Table: Summary statistics for calcium for complete DO dataset
...
## ACME             1.6482       1.0391         2.43  <2e-16 ***
## ADE             12.9034      11.3012        14.63  <2e-16 ***
## Total Effect    14.5516      12.8047        16.30  <2e-16 ***
## Prop. Mediated   0.1133       0.0717         0.17  <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## 
##                Estimate 95% CI Lower 95% CI Upper p-value    
## ACME              8.110        5.571        10.66  <2e-16 ***
## ADE              24.010       19.457        29.09  <2e-16 ***
## Total Effect     32.119       28.080        36.05  <2e-16 ***
## Prop. Mediated    0.252        0.169         0.34  <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
...
## 
##                Estimate 95% CI Lower 95% CI Upper p-value    
## ACME             2.0783       1.2540         3.03  <2e-16 ***
## ADE             12.5614      10.9479        14.34  <2e-16 ***
## Total Effect    14.6397      12.9032        16.36  <2e-16 ***
