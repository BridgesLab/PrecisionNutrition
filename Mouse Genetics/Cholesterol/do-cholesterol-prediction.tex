...
\hypersetup{
  ...
  pdfauthor={Dave Bridges and Cody Cousineau},
  hidelinks,
...
\NormalTok{cholesterol.data }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{summarize\_at}\NormalTok{(}\AttributeTok{.vars=}\FunctionTok{vars}\NormalTok{(chol1,chol2,chol.avg), }\AttributeTok{.funs=}\FunctionTok{list}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\FunctionTok{shapiro.test}\NormalTok{(.)}\SpecialCharTok{$}\NormalTok{p.value)) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable}\NormalTok{(}\AttributeTok{caption=}\StringTok{"Groupwise Shapiro{-}Wilk normality tests for cholesterol levels"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1200}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 14\tabcolsep) * \real{0.1600}}@{}}
\caption{Cholesterol levels at 11 and 18 weeks}\tabularnewline
\toprule()
...
\FunctionTok{wilcox.test}\NormalTok{(cholesterol.data}\SpecialCharTok{$}\NormalTok{chol2,}
\NormalTok{       cholesterol.data}\SpecialCharTok{$}\NormalTok{chol1, }
       \AttributeTok{paired=}\ConstantTok{TRUE}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ tidy }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{kable}\NormalTok{(}\AttributeTok{caption=}\StringTok{"Pairwise t{-}test ofcholesterol levels week 11 and week 18"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.1205}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0964}}
...
\midrule()
\endhead
149882 & 0.456 & Wilcoxon signed rank test with continuity correction &
two.sided \\
\bottomrule()
\end{longtable}
