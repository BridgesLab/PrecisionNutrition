...
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{select}\NormalTok{(chol1,sex,mouse.id,ENSEMBL.ID,expression) }\SpecialCharTok{\%\textgreater{}\%}
...
\midrule()
\endhead
\url{GO:0051640} & organelle localization & 113 & -0.874 & -1.81 & 0 &
0.131 \\
\bottomrule()
\end{longtable}
